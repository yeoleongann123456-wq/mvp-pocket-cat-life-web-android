...
export default function BottomNav() {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 mx-auto flex max-w-[460px] gap-1 overflow-x-auto border-t border-white/10 bg-[#2a1c2d]/90 px-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl">
      {items.map((item) => {
